export default [
    ...
    `You're such a fucking liar, Ele`,
    ...
    `A wise man once said "don't forget your scoopy snack"`,
    `I will not meet your mother today, hamster!`,
    // `She may be hot, but I prefer my spritzer cold`,
    `Are you old or did you just forget your stick?`,
    ...
    `Stop that Nine, no one does that anymore`,
    ...
    // `If you think I'm hot you should see my collection of `,
    ...
    `Picking up hotties at the Red Stone rally`,
    ...
    `My boyfriend is so unique, he eats lips by tongue flicking`,
    // `Not long ago a wizard told me I'd remain this flip`,
    `Oh yeah this shirt was half off, bring me the stressless!`,
    ...
    `Pillow fights are great until someone forgets its pillow`,
    ...
    `I'm never not thinking about that time I met by boss on toilet`,
    `Sit back and roll my big fatty Scoobie Doobie`,
    ...
    `People who make sounds when sucking a lollipop should be awarded`,
    ...
    `If you're into Vikings you should meet my cousin wain`,
